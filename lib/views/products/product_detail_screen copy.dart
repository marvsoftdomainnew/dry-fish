...
//     // 🟢 assign data to your local variables (used in UI)
//     // final productName = product.name ?? "Unknown";
//     final imageUrl = product.image ?? "assets/images/banner2.jpg";
//     final price = product.price?.toString() ?? 0.0;

//     // optional: update your cuts list dynamically if API provides cut info
//     cuts = [
//       {
//         "name": "Fry Cut",
//         "price": price,
